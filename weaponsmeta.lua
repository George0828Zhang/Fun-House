  ...
  <AttachPoints>
    <Item>
      ...
      <Components>
        ...
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CLIP_FMJ</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CLIP_INCENDIARY</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CLIP_TRACER</Name>
          <Default value="false" />
        </Item>
      </Components>
    </Item>
    ...
    <Item>
      ...
      <Components>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_02</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_03</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_04</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_05</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_06</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_07</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_08</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_09</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_10</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_CARBINERIFLE_MK2_CAMO_IND_01</Name>
          <Default value="false" />
        </Item>
      </Components>
    </Item>
...
<Item type="CWeaponInfo">
  ...
  <Model>w_lr_rpg</Model>
  <Audio>AUDIO_ITEM_HOMING_LAUNCHER</Audio>
  <AmmoInfo ref="AMMO_RPG" />
  <AnimReloadRate value="1.500000" />
...
<Item type="CWeaponInfo">
  <Name>WEAPON_HEAVYRIFLE</Name>
  <Damage value="54.000000" />
  <ForceHitPed value="250.000000" />
  <AnimReloadRate value="1.500000" />
  <TimeBetweenShots value="0.5000" />
  <AttachPoints>
    <Item>
      <AttachBone>WAPClip</AttachBone>
      <Components>
    ...
    <Item>
      <AttachBone>WAPFlshLasr_3</AttachBone>
      <Components>
        <Item>
          <Name>COMPONENT_AT_AR_FLSH</Name>
          <Default value="false" />
    ...
    <Item>
      <AttachBone>WAPGrip_3</AttachBone>
      <Components>
        <Item>
    ...
    <Item>
      ...
      <Components>
        <Item>
          <Name>COMPONENT_HEAVYRIFLE_CAMO1</Name>
          <Default value="false" />
        </Item>
      </Components>
    </Item>
...
<Item type="CWeaponInfo">
  ...
  <WeaponFlags>ArmourPenetrating CarriedInHand Automatic Gun CanLockonOnFoot CanLockonInVehicle CanFreeAim AnimReload AnimCrouchFire UsableOnFoot UsableClimbing UsableInCover AllowEarlyExitFromFireAnimAfterBulletFired AllowCloseQuarterKills HasLowCoverReloads HasLowCoverSwaps QuitTransitionToIdleIntroOnWeaponChange DisableLeftHandIkWhenOnFoot TorsoIKForWeaponBlock UseFPSAimIK UseFPSSecondaryMotion</WeaponFlags>
</Item>
<Item type="CWeaponInfo">
  <Name>WEAPON_HEAVYSHOTGUN</Name>
  <DamageType>EXPLOSIVE</DamageType>
  <Explosion>
    <Default>EXPLOSIVEAMMO_SHOTGUN</Default>
  ...
  <LightlyArmouredDamageModifier value="0.080000" />
  <VehicleDamageModifier value="0.150000" />
  <Force value="200.000000" />
  <ForceHitPed value="500.000000" />
  ...
  <MinTimeBetweenRecoilShakes value="50" />
  <AttachPoints>
    <Item>
      <AttachBone>WAPClip</AttachBone>
      <Components>
        <Item>
          <Name>COMPONENT_HEAVYSHOTGUN_CLIP_01</Name>
          <Default value="false" />
        </Item>
        <Item>
          <Name>COMPONENT_HEAVYSHOTGUN_CLIP_02</Name>
          <Default value="false" />
        </Item>
        <Item>
  ...
  <WeaponFlags>CarriedInHand Automatic ApplyBulletForce Gun CanLockonOnFoot CanLockonInVehicle CanFreeAim TwoHanded AnimReload AnimCrouchFire UsableOnFoot UsableInCover AllowEarlyExitFromFireAnimAfterBulletFired NoLeftHandIKWhenBlocked AllowCloseQuarterKills HasLowCoverReloads HasLowCoverSwaps LongWeapon UseFPSAimIK UseFPSSecondaryMotion FPSOnlyExitFireAnimAfterRecoilEnds SkipVehiclePetrolTankDamage</WeaponFlags>
</Item>
<Item type="CWeaponInfo">
...
<Item type="CWeaponInfo">
  ...
  <AmmoInfo ref="AMMO_GRENADELAUNCHER" />
  <AnimReloadRate value="1.500000" />
  <BulletsPerAnimLoop value="1" />
  <TimeBetweenShots value="1.220000" />
  <ReticuleStyleHash>VULCAN_ROCKET</ReticuleStyleHash>
  <FirstPersonReticuleStyleHash>VULCAN_ROCKET</FirstPersonReticuleStyleHash>
  <AttachPoints>
    <Item>
      <AttachBone>WAPClip</AttachBone>
      <Components>
...
<Item type="CAmmoProjectileInfo">
  <Name>AMMO_GRENADELAUNCHER</Name>
  ...
  <AmmoFlags>AddSmokeOnExplosion Fuse</AmmoFlags>
  <LifeTime value="15.000000" />
  <FromVehicleLifeTime value="15.000000" />
  <LifeTimeAfterImpact value="3.000000" />
  <ExplosionTime value="30.000000" />
  <LaunchSpeed value="50.000000" />
  <TimeToReachTarget value="2.000000" />
  <Damping value="0.020000" />
  ...
  <ClusterExplosionTag>BZGAS</ClusterExplosionTag>
  <ClusterExplosionCount value="5" />
  <ClusterMinRadius value="2.500000" />
  <ClusterMaxRadius value="4.500000" />
